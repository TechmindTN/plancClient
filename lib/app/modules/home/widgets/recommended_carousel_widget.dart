...
class RecommendedCarouselWidget extends GetWidget<HomeController> {
  ...
  Widget build(BuildContext context) {
    print("length is " + eServiceController.providers.length.toString());
    return Container(
      height: 345,
      ...
      child: Obx(() {
        return ListView.builder(
            ...
            itemCount: eServiceController.providers.length,
            itemBuilder: (_, index) {
              // var _service = controller.eServices.elementAt(index);
              var _service = eServiceController.providers.elementAt(index);
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              eServiceController.providers[index].name,
                              // _service.title,
                              maxLines: 2,
