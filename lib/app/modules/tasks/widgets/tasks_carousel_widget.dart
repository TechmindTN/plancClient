...
class TasksCarouselWidget extends GetWidget<TasksController> {
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    if (snapshot.hasData) {
                      return ListView.builder(
                          ...
                          itemBuilder: (_, index) {
                            controller.selectedTask.value = snapshot.data.first;

                            var _service =
                                snapshot.data.elementAt(index).provider;
                            var _task = snapshot.data.elementAt(index);
